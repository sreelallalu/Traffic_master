...
public class NavDrawerListAdapter extends BaseAdapter {
    ...
    private List<DriverDetails> navDrawerItems=new ArrayList<>();

    public NavDrawerListAdapter(Context context, List<DriverDetails> navDrawerItems){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        amout.setText(navDrawerItems.get(position).getAmount());
        reas.setText(navDrawerItems.get(position).getReason());
